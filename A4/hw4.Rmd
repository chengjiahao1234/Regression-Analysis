...
parTableVote[1:4, 1] <- exp(parTableVote[1:4, 1])
...
parTableCOVID[1:4, 1] <- exp(parTableCOVID[1:4, 1])
...
```{r Q2 Test}
Ecol2 = mapmisc::colourScale(UK2$cases/UK2$E, breaks = casesCol$breaks, col = casesCol$col, style = "fixed")
mapmisc::map.new(UK2)
plot(UK2, col = Ecol2$plot, add = TRUE, lwd = 0.2)
mapmisc::legendBreaks("left", casesCol, bty = "n")
```
